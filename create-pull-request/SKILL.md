...
<Simple, 1-2 line summary. Avoid jargon. Say what and why.>

## Key points

- <1-3 bullet highlights>
- <Anything reviewers should notice>

## 🧪 How to test

- <Quick QA steps or checklist preffixed by `- [ ]`>
EOF
)"
```

**PR summary must be clear and easy—should take less than 3 minutes to read. Avoid fluff.**
